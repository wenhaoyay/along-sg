...
const baseRecommendation = {
  ...
  route_geometry: [cck.coordinate, lotOneStop.coordinate, fajar.coordinate],
};
const alternative = {
  ...baseRecommendation,
...
const multiRecommendation = {
  ...baseRecommendation,
  stops: [{ ...lotOneStop, businesses: [lotOneStop.businesses[0]] }, secondStop],
  consolidated: false,
  total_duration_minutes: 43,
  incremental_detour_minutes: 14,
  stop_relationship: "nearby_separate_stores",
  route_geometry: [cck.coordinate, lotOneStop.coordinate, secondStop.coordinate, fajar.coordinate],
};
...
test("capture required V0.7.2 UI review states", async ({ page }, testInfo) => {
  ...
  await page.route("**/api/catalog/categories", (route) =>
    route.fulfill({
      ...
      body: JSON.stringify([
        { slug: "fast_food", name: "Food", parent_slug: "food_drink", outlet_count: 300 },
        {
          slug: "fried_chicken",
          name: "Fried chicken",
        ...
        { slug: "bubble_tea", name: "Bubble tea", parent_slug: "food_drink", outlet_count: 225 },
        { slug: "coffee", name: "Coffee", parent_slug: "food_drink", outlet_count: 1800 },
        { slug: "groceries", name: "Groceries", parent_slug: "shopping", outlet_count: 600 },
        { slug: "pharmacy", name: "Pharmacy", parent_slug: "shopping", outlet_count: 140 },
      ]),
    }),
  );
      ...
      body: JSON.stringify([
        {
          ...
          kind: "brand",
          canonical_brand: "Burger King",
          categories: ["fast_food"],
          outlet_count: 55,
          example_location: "Lot One",
        },
      ]),
    }),
  );
